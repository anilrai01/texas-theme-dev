 ...
 *@package Buziness
 */
    $sr_content_type         = buziness_get_option( 'sr_content_type' );
    $number_of_sr_items      = buziness_get_option( 'number_of_sr_items' );
    $featured_slider_overlay = buziness_get_option( 'featured_slider_overlay' );
    
    for( $i=1; $i<=$number_of_sr_items; $i++ ) :
        $featured_slider_posts[] = buziness_get_option( 'slider_page_'.$i );
    endfor;
    ?>
