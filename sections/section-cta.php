...
?>
    <?php 
        $cta_overlay            = buziness_get_option( 'cta_overlay' );
        $cta_small_description  = buziness_get_option( 'cta_small_description' );
        $cta_description        = buziness_get_option( 'cta_description' );
        $cta_button_label       = buziness_get_option( 'cta_button_label' );
        $cta_button_url         = buziness_get_option( 'cta_button_url' );
    ?>
