...
*/
 jQuery(document).ready(function($) {
    $('#buziness-img-container li label img').click(function(){    	
        $('#buziness-img-container li').each(function(){
            $(this).find('img').removeClass ('buziness-radio-img-selected') ;
        });
        $(this).addClass ('buziness-radio-img-selected') ;
    });                    
});
