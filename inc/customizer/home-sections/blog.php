...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'buziness' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_blog_section]', 
	array(		
	'label' 	=> __('Disable Blog Section', 'buziness'),
...
$wp_customize->add_control('theme_options[blog_title]', 
	...
	'active_callback' => 'buziness_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control(
	new buziness_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'buziness' ),
		'section'  => 'section_home_blog',
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       => __( 'Number of Posts', 'buziness' ),
		'description' => __('Maximum number of post to show is 12.', 'buziness'),
		'section'     => 'section_home_blog',
		'active_callback' => 'buziness_blog_active',		
		'type'        => 'number',
		'priority'    => 100,
