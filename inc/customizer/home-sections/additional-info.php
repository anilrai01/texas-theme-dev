...
$wp_customize->add_section( 'section_additional_info',
	array(
		'title'      => __( 'Our Services', 'buziness' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_additional_info_section]', 
	array(		
	'label' 	=> __('Disable Additional Information Section', 'buziness'),
...
$wp_customize->add_control('theme_options[additional_info_section_title]', 
	...
	'type'        => 'text',
	'active_callback' => 'buziness_additional_info_active',
	)
);
...
for( $i=1; $i<=$number_of_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[additional_info_icon_'.$i.']', 
		array(
		'label'       => sprintf( __('Select Icon #%1$s', 'buziness'), $i),
		'description' => sprintf( __('Please input icon as eg: fa fa-archive. Find Font-awesome icons %1$shere%2$s', 'buziness'), '<a href="' . esc_url( 'https://fontawesome.com/cheatsheet' ) . '" target="_blank">', '</a>' ),
		'section'     => 'section_additional_info',   
	...
	$wp_customize->add_control('theme_options[additional_info_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'buziness_additional_info_page',
		)
	);
}